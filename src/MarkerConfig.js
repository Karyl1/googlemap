            ...
            <div className="MarkerConfig">
                ...
                <div>
                    <ul className="ulDroit">
                        ...
                        <li> <input className="formText" placeholder="Votre titre..." id="titre"/></li>
                        
                        <li><textarea className="formText" placeholder="Votre texte..." id="inputxt"></textarea></li>
                        
                        <li><input className="formText" placeholder="https://votre-image.exemple" id="inputClick" type="text"/></li>
